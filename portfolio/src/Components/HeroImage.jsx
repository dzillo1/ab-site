...
function HeroImage() {
    ...
    return(
            ...
            <path className="lg-screen" style={{fill:"#ECF0F1"}} d="M50.218,163.474h368.805v85.374H50.218V163.474z"/>
            ...
            <path className="lg-screen" style={{fill:"#000000"}} d="M426.986,156.83H42.256V140.16c0-3.876,3.227-7.103,7.103-7.103h370.52
                c3.876,0,7.103,3.227,7.103,7.103v16.669H426.986z"/>
            <path className="lg-screen" style={{fill:"#ffffff"}} d="M206.441,139.861H403.52c1.453,0,2.636,1.186,2.636,2.636v4.891c0,1.453-1.186,2.636-2.636,2.636
                H206.441c-1.453,0-2.636-1.186-2.636-2.636v-4.891C203.805,141.047,204.99,139.861,206.441,139.861z"/>
            <g className="sm-screen" >
                <path className="lg-screen" style={{fill:"#ECF0F1"}} d="M58.624,139.68c3.292,0,5.962,2.668,5.962,5.962s-2.67,5.962-5.962,5.962
                    c-3.295,0-5.967-2.668-5.967-5.962S55.327,139.68,58.624,139.68z"/>
                <path className="lg-screen" style={{fill:"#ECF0F1"}} d="M82.16,139.68c3.295,0,5.962,2.668,5.962,5.962s-2.668,5.962-5.962,5.962
            ...
            <path className="md-screen" style={{fill:"#000000"}} d="M404.64,313.651c5.896,0,10.678,4.782,10.678,10.678c0,5.896-4.782,10.678-10.678,10.678
                c-5.896,0-10.678-4.782-10.678-10.678C393.962,318.432,398.744,313.651,404.64,313.651z"/>
            <path className="md-screen" style={{fill:"#DCE3DB"}} d="M389.319,339.587h30.642v2.167h-30.642V339.587z M389.319,353.203h20.583v2.167h-20.583V353.203z
                 M389.319,346.393h30.642v2.167h-30.642V346.393z"/>
            <path className="md-screen" style={{fill:"#000000"}} d="M466.446,227.782H331.904v-14.636c0-0.501,0.406-0.907,0.907-0.907h132.724
            ...
            <path className="md-screen" style={{fill:"#ffffff"}} d="M381.219,217.442h80.009c0.59,0,1.07,0.635,1.07,1.411v2.618c0,0.776-0.48,1.411-1.07,1.411h-80.009
                c-0.59,0-1.07-0.635-1.07-1.411v-2.618C380.149,218.077,380.629,217.442,381.219,217.442z"/>
            <path className="sm-screen" style={{fill:"#000000"}} d="M498.389,286.941h-57.927v-6.4c0-0.218,0.176-0.391,0.391-0.391h57.145
                c0.216,0,0.391,0.173,0.391,0.391L498.389,286.941L498.389,286.941z"/>
            <path className="sm-screen" style={{fill:"#ffffff"}} d="M444.554,281.299c1.107,0,2.001,0.894,2.001,2.001c0,1.104-0.894,2.001-2.001,2.001
            ...
            <path className="lg-screen" style={{fill:"#013514"}} d="M40.323,393.97h431.353c-1.429,2.23-2.903,4.425-4.398,6.607H44.724
                C43.229,398.395,41.753,396.199,40.323,393.97z"/>
            <path className="md-screen" style={{fill:"#B6B6B8"}} d="M382.161,203.956h34.033c0.484,0,0.876,0.392,0.876,0.876v0.003c0,0.484-0.392,0.876-0.876,0.876
